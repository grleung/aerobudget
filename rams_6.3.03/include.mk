...
#############################################################################
RAMS_ROOT=/home6/grleung1/rams_6.3.03
RAMS_VERSION=6.3.03
...
#############################################################################
HDF5_ROOT=/home6/grleung1/misc/hdf5-1.10.6-par
...
# (-check bounds) for array bounds checking, (-fp-model precise) for IEEE
# (-check uninit) for finding uninitialized variables, (-free) for free format
F_COMP=/nasa/intel/Compiler/2018.3.222/compilers_and_libraries_2018.3.222/linux/bin/intel64/ifort
...
LIBS=-L/usr/lib/x86_64-linux-gnu -lrt -lpthread -lz  -L/nasa/szip/2.1.1/lib
...
#############################################################################
C_COMP=gcc
C_OPTS=-O3 -DUNDERSCORE -DLITTLE -std=gnu99 -DENABLE_PARALLEL_COMPRESSION -w #-DRAMS_DOUBLE_PREC
